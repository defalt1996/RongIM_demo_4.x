...
public final class ImageLoaderConfiguration {
     ...
     * <li>diskCache = {@link io.rong.imageloader.cache.disc.impl.UnlimitedDiskCache}</li>
    ...
    public static ImageLoaderConfiguration createDefault(Context context,String savePath) {
        return new Builder(context).build(savePath);
    }
    ...
    public static class Builder {
        ...
        /**
         * @deprecated Use
         * {@link #diskCacheExtraOptions(int, int, io.rong.imageloader.core.process.BitmapProcessor)}
         * instead
         */
        @Deprecated
         ...
         * {@link io.rong.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
         ...
         * Default value - {@link io.rong.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
         ...
         * <b>NOTE:</b> If you use this method then
         * {@link io.rong.imageloader.cache.disc.impl.ext.LruDiskCache LruDiskCache}
        ...
        /** @deprecated Use {@link #diskCacheFileNameGenerator(io.rong.imageloader.cache.disc.naming.FileNameGenerator)} */
        @Deprecated
         ...
         * Default value -
         * {@link io.rong.imageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
        ...
        /** @deprecated Use {@link #diskCache(io.rong.imageloader.cache.disc.DiskCache)} */
        @Deprecated
         ...
         * Default value - {@link io.rong.imageloader.cache.disc.impl.UnlimitedDiskCache
         * UnlimitedDiskCache}. Cache directory is defined by
         * {@link io.rong.imageloader.utils.StorageUtils#getCacheDirectory(Context)
         ...
         * Default value -
         * {@link io.rong.imageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
         ...
         * Default value -
         * {@link io.rong.imageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
         ...
         * Consider {@link io.rong.imageloader.utils.L#disableLogging()} to disable
        ...
        public ImageLoaderConfiguration build(String savePath) {
            initEmptyFieldsWithDefaultValues(savePath);
            return new ImageLoaderConfiguration(this);
        }
        ...
        private void initEmptyFieldsWithDefaultValues(String savePath) {
            if (taskExecutor == null) {
                taskExecutor = DefaultConfigurationFactory
                        .createExecutor(threadPoolSize, threadPriority, tasksProcessingType);
            } else {
            ...
            if (diskCache == null) {
                ...
                diskCache = DefaultConfigurationFactory
                        .createDiskCache(context, diskCacheFileNameGenerator, diskCacheSize, diskCacheFileCount,savePath);
            }
            if (memoryCache == null) {
                memoryCache = DefaultConfigurationFactory.createMemoryCache(context, memoryCacheSize);
            }
     ...
     * using {@link io.rong.imageloader.core.assist.FlushedInputStream}.
     *
     * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
     * @since 1.8.1
     */
