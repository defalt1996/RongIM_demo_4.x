 ...
 * display it in {@link io.rong.imageloader.core.imageaware.ImageAware} using {@link DisplayBitmapTask}.
 *
            ...
            public void run() {
                if (options.shouldShowImageOnFail()) {
                    if (options.getDisplayer() != null) {
                        Bitmap bitmap = options.drawableToBitmap(options.getImageOnFail(configuration.resources));
                        if (bitmap != null)
