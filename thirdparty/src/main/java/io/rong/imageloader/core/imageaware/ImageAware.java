 ...
 * through {@link io.rong.imageloader.core.ImageLoader ImageLoader}.
 * It can wrap any Android {@link View View} which can be accessed by {@link #getWrappedView()}. Wrapped
 * view is returned in {@link io.rong.imageloader.core.listener.ImageLoadingListener ImageLoadingListener}'s
 * callbacks.
 *
...
public interface ImageAware {
    ...
    /**
     * Returns {@linkplain io.rong.imageloader.core.assist.ViewScaleType scale type} which is used for
     ...
     * {@link io.rong.imageloader.core.listener.ImageLoadingListener#onLoadingCancelled(String,
     ...
     * {@linkplain io.rong.imageloader.core.DisplayImageOptions.Builder#showImageForEmptyUri(
     *Drawable) for empty Uri},
     * {@linkplain io.rong.imageloader.core.DisplayImageOptions.Builder#showImageOnLoading(
     *Drawable) on loading} or
     * {@linkplain io.rong.imageloader.core.DisplayImageOptions.Builder#showImageOnFail(
     *Drawable) on loading fail}. These drawables can be specified in
     * {@linkplain io.rong.imageloader.core.DisplayImageOptions display options}.<br />
     * Also can be called in {@link io.rong.imageloader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
     * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
     *
     ...
     * {@link io.rong.imageloader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
     * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
     *
