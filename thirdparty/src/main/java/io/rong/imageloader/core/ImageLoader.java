...
public class ImageLoader {
     ...
     * @param imageAware {@linkplain io.rong.imageloader.core.imageaware.ImageAware Image aware view}
     ...
     * @param imageAware {@linkplain io.rong.imageloader.core.imageaware.ImageAware Image aware view}
     *                   which should display image
     * @param options    {@linkplain io.rong.imageloader.core.DisplayImageOptions Options} for image
     ...
     * @param progressListener {@linkplain io.rong.imageloader.core.listener.ImageLoadingProgressListener
     *                         Listener} for image loading progress. Listener fires events on UI thread if this method
     *                         is called on UI thread. Caching on disk should be enabled in
     *                         {@linkplain io.rong.imageloader.core.DisplayImageOptions options} to make
     *                         this listener work.
     * @throws IllegalStateException    if {@link #init(ImageLoaderConfiguration)} method wasn't called before
     * @throws IllegalArgumentException if passed <b>imageAware</b> is null
     */
    ...
    public void displayImage(String uri, ImageAware imageAware, DisplayImageOptions options,
        ...
        if (TextUtils.isEmpty(uri)) {
            ...
            if (options.shouldShowImageForEmptyUri()) {
                if (options.getDisplayer() != null) {
                    Bitmap bitmap = options.drawableToBitmap(options.getImageForEmptyUri(configuration.resources));
                    if (bitmap != null)
        ...
        if (bmp != null && !bmp.isRecycled()) {
            ...
            if (options.shouldShowImageOnLoading()) {
                if (options.getDisplayer() != null) {
                    Bitmap bitmap = options.drawableToBitmap(options.getImageOnLoading(configuration.resources));
                    if (bitmap != null)
                        options.getDisplayer().display(bitmap, imageAware, LoadedFrom.DISC_CACHE);
                } else {
     ...
     * {@link io.rong.imageloader.core.imageaware.ImageAware ImageAware}
     */
     ...
     * {@link io.rong.imageloader.core.imageaware.ImageAware ImageAware}.
     *
     * @param imageAware {@link io.rong.imageloader.core.imageaware.ImageAware ImageAware} for
     ...
     * {@linkplain io.rong.imageloader.core.ImageLoaderConfiguration.Builder#taskExecutor(java.util.concurrent.Executor)
