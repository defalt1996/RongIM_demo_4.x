 ...
 * <p>&nbsp;</p>
 * To be used via {@link io.rong.photoview.PhotoViewAttacher#setOnDoubleTapListener(GestureDetector.OnDoubleTapListener)}
 */
    ...
    public boolean onSingleTapConfirmed(MotionEvent e) {
        ...
        if (null != photoViewAttacher.getOnPhotoTapListener()) {
            ...
            if (null != displayRect) {
                ...
                //原本只是点击图片区域才返回点击事件，因为需要修改 RCE 点击黑色区域也需要 finish 不判断 x y 区域，原本代码 displayRect.contains(x,y)
