...
public class AMapLocationActivity extends RongBaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send = findViewById(R.id.rc_action_bar_ok);
        send.setText(getResources().getString(R.string.rc_ext_send));
        send.setVisibility(View.VISIBLE);
        send.setOnClickListener(this);
        boolean netWorkAvailable = NetUtils.isNetWorkAvailable(this);
        if (netWorkAvailable) {
            send.setEnabled(true);
            send.setTextColor(getResources().getColor(R.color.rc_map_send_enabled));
        } else {
            send.setEnabled(false);
            send.setTextColor(getResources().getColor(R.color.rc_map_send_not_enabled));
        }
    ...
    private void addLocatedMarker(LatLng latLng, String poi) {
        mBitmapDescriptor = BitmapDescriptorFactory.fromResource(R.drawable.rc_ext_location_marker);
