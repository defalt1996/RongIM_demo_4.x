...
public class WebFilePreviewActivity extends RongBaseActivity implements View.OnClickListener {
    ...
    private void initData() {
        ...
        mFileTypeImage.setImageResource(FileTypeUtils.fileTypeImageId(getApplicationContext(), mFileDownloadInfo.fileName));
        ...
        RongIM.getInstance().supportResumeBrokenTransfer(mFileDownloadInfo.url, new RongIMClient.ResultCallback<Boolean>() {
            @Override
    ...
    protected void refreshDownloadState() {
        switch (mFileDownloadInfo.state) {
            ...
            case DOWNLOADING:
                ...
                mFileSizeView.setText(getString(R.string.rc_ac_file_download_progress_tv,
                        FileTypeUtils.formatFileSize(downloadedFileLength), FileTypeUtils.formatFileSize(mFileDownloadInfo.size)));
            ...
            case DOWNLOAD_ERROR:
                if (supportResumeTransfer == SupportResumeStatus.SUPPORT) {
                    ...
                    mFileSizeView.setText(getString(R.string.rc_ac_file_download_progress_pause,
                            FileTypeUtils.formatFileSize(downloadedFileLength), FileTypeUtils.formatFileSize(mFileDownloadInfo.size)));
    ...
    private void downloadFile() {
        ...
        RongIM.getInstance().downloadMediaFile(mFileDownloadInfo.uid, mFileDownloadInfo.url,
