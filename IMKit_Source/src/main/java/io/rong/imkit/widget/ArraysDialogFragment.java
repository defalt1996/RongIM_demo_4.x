...
public class ArraysDialogFragment extends BaseDialogFragment {
    ...
    public interface OnArraysDialogItemListener {
        void OnArraysDialogItemClick(DialogInterface dialog, int which);
    }

    public void show(FragmentManager manager) {
        String[] arrays = getArguments() != null ? getArguments().getStringArray(ARGS_ARRAYS) : new String[0];
        setCount(arrays != null ? arrays.length : 0);
