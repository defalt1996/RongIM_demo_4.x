...
public class RongConfigurationManager {
    ...
    public static void init(Context context) {
        if (!isInit) {
            ...
            RCLocale locale = RongConfigurationManager.getInstance().getAppLocale(context);
    ...
    public void setFileMaxSize(Context context, int size) {
        SharedPreferences sharedPreferences = SharedPreferencesUtils.get(context, RONG_CONFIG, Context.MODE_PRIVATE);
