...
public class FileTypeUtils {
    ...
    public static Intent getOpenFileIntent(String fileName, String fileSavePath) {
        ...
        String type = getIntentType(RongIM.getInstance().getApplicationContext(), intent, fileName);
        if (type != null && fileSavePath != null
                && isIntentHandlerAvailable(RongIM.getInstance().getApplicationContext(), intent)) {
            Uri uri = FileProvider.getUriForFile(RongIM.getInstance().getApplicationContext(), RongIM.getInstance().getApplicationContext().getPackageName() + RongIM.getInstance().getApplicationContext().getResources().getString(R.string.rc_authorities_fileprovider), new File(fileSavePath));
    ...
    public static Intent getOpenFileIntent(Context context, String fileName, Uri uri) {
        ...
        if (type != null && uri != null && isIntentHandlerAvailable(context, intent)) {
            if (FileUtils.uriStartWithContent(uri)) {
                ...
                Uri fileUri = FileProvider.getUriForFile(context, context.getPackageName() + context.getResources().getString(R.string.rc_authorities_fileprovider), new File(path));
