...
public class RongLinkify {
    private static final String TAG = "RongLinkify";
    /**
    ...
    //private static final String WEB_URL_REGEX = "[(https?|ftp|file)://]?[-a-zA-Z0-9+&@#/%?=~_|!:,.;]*[-a-zA-Z0-9+&@#/%=~_|]";
    // wechat like url pattern
    ...
    public static boolean addLinks(Spannable text, int mask) {
        ...
        if ((mask & WEB_URLS) != 0) {
            gatherLinks(links, text, WEB_URL,
    ...
    public static void addLinks(TextView text, Pattern p, String scheme,
                                android.text.util.Linkify.MatchFilter matchFilter, android.text.util.Linkify.TransformFilter transformFilter) {
    ...
    public static boolean addLinks(Spannable s, Pattern p,
                                   String scheme, android.text.util.Linkify.MatchFilter matchFilter,
    ...
    private static String makeUrl(String url, String[] prefixes,
                                  Matcher m, android.text.util.Linkify.TransformFilter filter) {
        if (filter != null) {
    ...
    private static void gatherTelLinks(ArrayList<LinkSpec> links, Spannable s, Pattern pattern) {
