            ...
            case OTHER:
                if (year == yearCur) {//同年
                    if (month == monthCur && weekInMonth == weekInMonthCur) {//同月同周
                        ...
                        if (context.getResources().getConfiguration().locale.getCountry().equals("CN")) {
                            formatDate = formatDate(date, "M" + context.getResources().getString(R.string.rc_month_format) +
                                    "d" + context.getResources().getString(R.string.rc_day_format));
                        } else {
                    ...
                    if (context.getResources().getConfiguration().locale.getCountry().equals("CN")) {
                        formatDate = formatDate(date, "yyyy" + context.getResources().getString(R.string.rc_year_format) +
                                "M" + context.getResources().getString(R.string.rc_month_format) +
                                "d" + context.getResources().getString(R.string.rc_day_format));
                    } else {
