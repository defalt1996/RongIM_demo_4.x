 ...
 */
public class ImageVideoDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mRootView = inflater.inflate(R.layout.rc_dialog_video_image, container, false);
        initView();
        return mRootView;
    }
    ...
    public void show(FragmentManager manager) {
        if (!hasSight && !hasImage) {
            if (getContext() != null) {
                Toast.makeText(getContext(), getContext().getResources().getString(R.string.rc_no_plugin), Toast.LENGTH_SHORT).show();
            }
            return;
        }
        try {
