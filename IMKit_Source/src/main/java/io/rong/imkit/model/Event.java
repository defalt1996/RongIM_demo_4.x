...
public class Event {
    ...
    public static class EncryptedConversationTerminatedEvent {
        ...
        public EncryptedConversationTerminatedEvent(String targetId) {
            this.targetId = targetId;
        }
    }

    public static class changeDestructionReadTimeEvent {

        public Message message;

        public changeDestructionReadTimeEvent(Message message) {
    ...
    public static class MediaFileEvent {
        ...
        public MediaFileEvent(String uid, int progress, int callBackType, RongIMClient.ErrorCode errorCode) {
            this.uid = uid;
            this.progress = progress;
            this.callBackType = callBackType;
            this.errorCode = errorCode;
    ...
    public static class OnReceiveMessageEvent {
        ...
        public OnReceiveMessageEvent(Message message, int left, boolean hasPackage, boolean offline) {
            this.message = message;
            this.left = left;
    ...
    public static class VoiceInputOperationEvent {
        ...
        public final static int STATUS_INPUTING = 0;
        public final static int STATUS_INPUT_COMPLETE = 1;
    ...
    public static class RecallMessageEditClickEvent extends BaseConversationEvent {
        private Message message;

        public RecallMessageEditClickEvent(Message message) {
            this.message = message;
        }
    ...
    public static class RemoteMessageRecallEvent {
        ...
        public RemoteMessageRecallEvent(int messageId, Conversation.ConversationType type, RecallNotificationMessage recallNotificationMessage, boolean recallSuccess, String targetId) {
            this.mMessageId = messageId;
            this.mRecallNotificationMessage = recallNotificationMessage;
            this.mRecallSuccess = recallSuccess;
    ...
    public static class ShowDurnDialogEvent {
    }
}
